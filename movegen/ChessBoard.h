...
private:
    ...
    void addCastling1 (MoveList& legalMoves, bitboard_t enemyAttackedSquares) const;
    void addEnPassant1 (MoveList& legalMoves, bitboard_t effectiveEnemyBishops, bitboard_t effectiveEnemyRooks) const;
    void addLegalKingMoves1 (MoveList& legalMoves, bitboard_t kingLegalEndSquares) const;
...
public:
    ...
    void getLegalMoves1(MoveList& legalMoves) const;
